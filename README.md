...
| Validator | `scripts/validate_package.py` | 19 build-time checks (below). CI runs it on every push. |
...
1. **Build time** — `scripts/validate_package.py`: 19 build-time checks cover
